#this script generates shipped beer boxes for beer club members
...
def getshippedbox():
    ...
    for shippedBoxUser in db1.shippedBox.find({"toMachineLearn":True}):
...
def checkinputs(inventoryInfo,beersData,shippedBox,userInfo,ratedBoxInfo):
    #check inventoryId
...
if __name__ == '__main__':
    ...
    #check all inputs
    checkinputs(inventoryInfo,beersData,shippedBox,userInfo,ratedBoxInfo)
    #get training data
